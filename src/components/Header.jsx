    ...
    return (
        <>
            ...
            <div className='p-1 flex justify-between'>
                ...
                <p className={`hidden mt-10 sm:block text-gray-500 my-auto font-semibold text-sm sm:text-xl md:text-2xl`}>
                    Public Podcasts
                </p>

                <p className={`block mt-10 sm:hidden text-gray-500 my-auto font-semibold text-md`}>
                    Podcasts
                </p>
                ...
                <div className='mt-5'>
                    <button
                        ...
                        className='block text-xs  sm:hidden w-fit h-10 my-3 mx-auto p-1 px-3 text-center rounded-full text-white font-semibold border-4  bg-gradient-to-r from-violet-700 to-purple-700 hover:border-violet-700  hover:text-white hover:shadow-2xl hover:shadow-violet-500 duration-700'>
                        Start a podcast
                    </button>
